...
public class FatSecretAPI {
    ...
    final static private String APP_KEY = "adc5ea1e94404d129c4fdd0fe6c652b8";
    static private String APP_SECRET = "cf9e3fbd63d54c7f8851f2e1b3b75a7b";
    final static private String APP_URL = "http://platform.fatsecret.com/rest/server.api";
    private static final String HMAC_SHA1_ALGORITHM = "HmacSHA1";


    public static JSONObject searchFood(String searchFood, int page) {
        ...
        try {
            ...
            JSONObject tmp = new JSONObject(builder.toString());
            food = tmp.getJSONObject("foods").getJSONObject("food");
            food = getFood(Long.parseLong(food.getString("food_id")));
    ...
    public static JSONObject getFood(Long ab) {
